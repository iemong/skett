        ...
        <Modal styleType="default" isShowing={isShowing} onClose={toggle} width={'600px'} height={'60%'}>
            <Inner>
                ...
                <p>
                    ...
                    <br />
                    (4)
                    「現地ユーザー」とは、ログインユーザーのうち、現地ニーズの解決を目的として、本サービスを利用して「現地の声」を投稿し、又は「支援の声」に対する応募を行う者をいいます。
                    <br />
                    (5) 「支援活動」とは、発災後の応急対応、復旧、復興に係る活動をいいます。
                    <br />
                    (6)
                    「支援ユーザー」とは、ログインユーザーのうち、現地で支援活動を行うことを目的として、本サービスを利用して「支援の声」を投稿し、又は「現地の声」に対する応募を行う者をいいます。
                    <br />
                ...
                <p>
                    第3条 （本サービスの目的）
                    <br />
                    本サービスは、現地ニーズに適合した支援活動を促進し、もって、発災後の応急対応、復旧、復興を推進するため、支援活動の契機となりうる支援ユーザーと現地ユーザーのマッチングを実現することを目的としたサービスです。なお、本サービス上で、現地ユーザーは「支援の声」に対し、支援ユーザーは「現地の声」に対して応募することができますが、応募後のユーザー間のコミュニケーション等については、SNSのメッセージ機能等を利用して、本サービス外で行うことになります。
                </p>
                ...
                <p>
                    ...
                    <br />
                    2.
                    現地ユーザー又は支援ユーザーは、「声」を投稿した後であっても、FD所定の方法により、当該「声」を削除し、または当該「声」の内容を編集することができます。
                    <br />
                    3.
                    ...
                    <br />
                    7.
                    現地ユーザー又は支援ユーザーは、(i)現地ニーズが解決した場合、(ii)支援活動を行うことが困難になった場合（現地ニーズへの支援活動を行うことが決定し、他の現地ニーズの支援活動を行うことが困難になった場合を含みます。）、(iii)その他の自らが投稿した「声」の内容に係る重要な事実又は前提条件が変更となった場合、FD所定の方法により、遅滞なく当該「声」について終了マークを表示するものとします。
                </p>
                ...
                <p>
                    ...
                    <br />
                    1.
                    現地ユーザーは「支援の声」に対し、支援ユーザーは「現地の声」に対し、FD所定の方法により応募することができるものとします。なお、本項の定めに従って応募が行われた場合でも、現地ユーザー及び支援ユーザーとの間で契約の成立その他の権利義務が発生するものではありません。
                    <br />
                    2.
                    現地ユーザー及び支援ユーザーは、前項の定めに従い「支援の声」又は「現地の声」に対する応募を行った場合、事後的に応募を取り消すことはできないものとします。
                    <br />
                    3.
                    現地ユーザー及び支援ユーザーは、第1項の定めに従い「支援の声」又は「現地の声」に対する応募を行った後であっても、(i)「声」が削除又は編集される場合があること、および、(ii)「声」に終了マークが表示される場合があることを確認するものとします。
                </p>
                ...
                <p>
                    ...
                    <br />
                    1.
                    ユーザーは、自らの判断及び責任の下で、SNSのメッセージ機能等を用いた他のユーザーとの連絡、現地における支援活動又はその受入れ、取引等を行うものとし、FDはこれらの事項について一切関知するものではなく、何らの責任を負うものではありません。
                    <br />
                    2.
                    ユーザーは、「声」の掲載又は「声」に対する応募その他の本サービスの利用に起因又は関連し、ユーザー間でクレーム、紛争等が発生した場合であっても、当事者間で、かつ、自らの責任及び費用負担の下でこれを解決するものとし、FDに一切の迷惑又は損害等を及ぼさないものとします。
                </p>

                <p>
                    第8条 （禁止行為）
                    <br />
                    1. ユーザーは、第3条に定める本サービスの目的以外の目的で本サービスを利用してはならないものとします。
                    <br />
                    2.
                    ...
                    ② 性行為やわいせつな行為を目的とする行為
                    <br />
                    ③ 宗教活動又は宗教団体への勧誘を目的とした行為
                    <br />
                    ④ 政治活動、選挙活動又は政治団体への勧誘を目的とした行為
                    <br />
                    ⑤ 情報商材、金融商品等の営業、宣伝、広告、勧誘その他の営利行為（支援活動に該当する行為を除きます。）
                    <br />
                    ...
                    ② 残虐な表現又は暴力的な表現
                    <br />
                    ③ 民族、国籍、宗教、人種、性別、年齢等に関する差別を誘発、助長する表現
                    <br />
                    ④ 犯罪、自殺、薬物使用等の勧誘、誘発、助長にあたる表現
                    <br />
                    ⑤ その他第三者に不快感を及ぼすおそれがあるとFDが判断する表現
                    <br />
                    ...
                    <br />
                    ② 本サービスに関するサーバー又はネットワークを破壊し、又は妨害する行為
                    <br />
                    ③ 本サービスに関する情報を破壊し、又は改ざんする行為
                    <br />
                    ④ FDが定める一定のデータ容量以上のデータを送信する行為
                    <br />
                    (6)
                ...
                <p>
                    第12条 （個人情報等の取扱い）
                    <br />
                    1. FDは、個人情報の保護に関する法律その他の法令及びFDの別途定める
                    <span onClick={onClickPrivacyPolicy}>プライバシーポリシー</span>
                    （以下「プライバシーポリシー」といいます。）の定めに従って本サービスに関連して取得した個人情報を取り扱うものとし、ユーザーはこれに同意するものとします。
                    <br />
                    2.
                    FDは、プライバシーポリシーの定めに従い、公的機関と連携して発災後の応急対応、復旧、復興を推進するため、本サービスの利用状況を国の機関、地方公共団体、社会福祉協議会その他の公的機関に提供することができるものとします。
                </p>
                ...
                <p>
                    ...
                    <br />
                    1.
                    FDは、本サービスについて、特定の目的への適合性、有用性、完全性、継続性等を含め、一切保証しないものとする。
                    <br />
                    2.
                ...
                <p>
                    ...
                    <br />
                    2.
                    前項ただし書に定める場合であっても、FDは、FDの故意又は過失により直接かつ通常生じたユーザーの損害に限って責任を負うものとし、特別損害、間接損害、逸失利益等については責任を負わないものとします。また、FDがユーザーに対して負う賠償責任は、10,000円を上限とします。
                </p>
