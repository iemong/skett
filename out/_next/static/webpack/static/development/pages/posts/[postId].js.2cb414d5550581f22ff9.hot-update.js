...
var PostDetail = function PostDetail(props) {
  ...
  var docRef = db.collection(_assets_constant__WEBPACK_IMPORTED_MODULE_19__["COLLECTIONS"].POSTS); // console.log(db.collection(COLLECTIONS.USERS).doc(data?.user.uid))

  db.collection(_assets_constant__WEBPACK_IMPORTED_MODULE_19__["COLLECTIONS"].USERS).doc(data === null || data === void 0 ? void 0 : data.user.uid).get().then(function (doc) {
...
//# sourceMappingURL=[postId].js.2cb414d5550581f22ff9.hot-update.js.map