...
var drawText = function drawText(context, text) {
  ...
  var trimedText = text.slice(0, lengthPerLine * maxLines - 1).replace(/$/, '…');
  context.save();
  context.beginPath();
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.next = 5;
            return drawImage(drawBG(ctx, options.postType), options.imageData);
...
//# sourceMappingURL=register.js.1d4ced0542d798180682.hot-update.js.map