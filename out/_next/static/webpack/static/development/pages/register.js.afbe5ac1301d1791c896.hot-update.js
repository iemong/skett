...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(context, imageData) {
    var image, imageWidth, imageHeight, ratio;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            if (ratio > 1) {
              context.drawImage(image, 0, 0, imageWidth * ratio, imageHeight, WIDTH / 2, 0, WIDTH, HEIGHT);
            } else {
              context.drawImage(image, 0, 0, imageWidth, imageHeight * ratio, WIDTH / 2, 0, WIDTH, HEIGHT);
            }
...
//# sourceMappingURL=register.js.afbe5ac1301d1791c896.hot-update.js.map